<template>
	...
	>
		...
		>
			<view
				class="lrc-item"
				v-for="(v, i) in mLyrics.lrcs"
				:key="i"
				@tap="select(v, i)"
				@longpress="itemLongpress(v, i)"
				@touchstart="textTouchstart"
				@touchcancel="textTouchEnd"
		...
		<view class="center-view" :style="{ top: centerLineTop, display: showCenterView ? 'flex' : 'none', fontSize: cuCenterStyle.fontSize, height: cuCenterStyle.height }">
			<image
				v-if="cuCenterStyle.btnImg"
				class="center-btn"
				@click="centerBtnClick"
				:src="cuCenterStyle.btnImg"
				:style="{ width: cuCenterStyle.height, height: cuCenterStyle.height }"
			></image>
		...
		>
			<view class="selectAll" @click="selectAll" :style="{ borderRadius: cuSelectControlStyle.itemBorderRadius, backgroundColor: cuSelectControlStyle.itemBackgroundColor }">
				{{ selectAllStatus ? '全不选' : '全选' }}
			</view>
			<view class="copy" @click="copyLyric" :style="{ borderRadius: cuSelectControlStyle.itemBorderRadius, backgroundColor: cuSelectControlStyle.itemBackgroundColor }">
				复制歌词
			</view>
			<view class="cancel" @click="selectCancel" :style="{ borderRadius: cuSelectControlStyle.itemBorderRadius, backgroundColor: cuSelectControlStyle.itemBackgroundColor }">
				取消
			</view>
		</view>
	</view>
