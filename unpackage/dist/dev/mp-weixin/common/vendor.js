...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"网抑云音乐","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var store = new _vuex.default.Store({
  ...
  getters: {
    ...
    getsignInState: function getsignInState(state) {
  ...
  mutations: {
    ...
    setsignInState: function setsignInState(state, status) {
