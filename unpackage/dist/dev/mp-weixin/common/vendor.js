...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"网抑云音乐","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var store = new _vuex.default.Store({
  ...
  getters: {
    ...
    getsongPlayUrl: function getsongPlayUrl(state) {
      return state.songPlayUrl;
    },
    getplaylist: function getplaylist(state) {
      return state.playlist;
    },
    getisPlay: function getisPlay(state) {
      return state.isPlay;
    },
    ...
    getsongDuration: function getsongDuration(state) {
      return state.songDuration;
    },
    getsongCurrentTime: function getsongCurrentTime(state) {
    ...
    getplayMessage: function getplayMessage(state) {
      return state.playMessage;
    } },

  mutations: {
    setsongInfo: function setsongInfo(state, status) {
      state.songInfo = status;
      uni.setStorageSync("store", state);
    },
    setsongPlayUrl: function setsongPlayUrl(state, status) {
      state.songPlayUrl = status;
      uni.setStorageSync("store", state);
    },
    setplaylist: function setplaylist(state, status) {
      state.playlist = status;
      uni.setStorageSync("store", state);
    },
    setisPlay: function setisPlay(state, status) {
      state.isPlay = status;
      uni.setStorageSync("store", state);
    },
    setserialNumber: function setserialNumber(state, status) {
      state.serialNumber = status;
      uni.setStorageSync("store", state);
    },
    setisShow: function setisShow(state, status) {
      state.isShow = status;
      uni.setStorageSync("store", state);
    },
    setsongDuration: function setsongDuration(state, status) {
      state.songDuration = status;
      uni.setStorageSync("store", state);
    },
    setsongCurrentTime: function setsongCurrentTime(state, status) {
    ...
    setplayMessage: function setplayMessage(state, status) {
...
/***/ 111:
/*!**************************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/static/less/videoDetails.less ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var that = "";
var bgAudioMannager = uni.getBackgroundAudioManager(); //音频api

// init audio组件实例化
_vue.default.prototype.initAudioContext = function (url, songInfo, isPlay) {
  that = this;
...
_vue.default.prototype.getplayMusic = function (songinfoId, songinfo) {
  // 根据id查看是否有权限播放
  var that = this,
  Wxcookie = "";
...
// 获取播放url
_vue.default.prototype.getsongUrl = function (Wxcookie, songinfoId, songinfo) {
  var that = this;
  uni.request({
...
// 下一首
_vue.default.prototype.nextSong = function (number, songlist) {
...
// 上一首
_vue.default.prototype.lastSong = function (number, songlist) {
...
// 播放
_vue.default.prototype.playAudio = function () {
  console.log("播放");
...
// 暂停
_vue.default.prototype.pauseAudio = function () {
  console.log("暂停");
...
_vue.default.prototype.playCurrentTime = function () {
...
_vue.default.prototype.getAudioStatus = function () {
...
_vue.default.prototype.getAudioUrl = function () {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _message = _interopRequireDefault(__webpack_require__(/*! ./message.js */ 186));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 284:
/*!******************************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/static/less/broadcastDetails.less ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 37:
/*!*********************************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/static/less/dailyRecommendation.less ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!*******************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/pages.json ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 44:
/*!***********************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/static/less/songSheet.less ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 53:
/*!*************************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/static/less/rankingList.less ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 61:
/*!********************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/static/less/search.less ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 70:
/*!****************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/static/less/me.less ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 77:
/*!*******************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/static/less/video.less ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 86:
/*!*****************************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/static/less/songListDetails.less ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
