...
/* 14 */
/*!*************************************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*************************************************************************************/
...
/* 15 */
/*!******************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/pages/index/index.vue ***!
  \******************************************************************/
/*! no static exports found */
...
/* 16 */
/*!*************************************************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*************************************************************************************************/
...
try {
  components = {
    ...
    uniDrawer: function() {
      return __webpack_require__.e(/*! import() | components/uni-drawer/uni-drawer */ "components/uni-drawer/uni-drawer").then(__webpack_require__.bind(null, /*! @/components/uni-drawer/uni-drawer.vue */ 159))
    }
  }
} catch (e) {
  if (
...
var render = function() {
  ...
  var l0 =
    _vm.recommendedSongList != "" &&
    _vm.recommendedSongList.creatives.length > 0
      ? _vm.__map(_vm.recommendedSongList.creatives, function(item, __i0__) {
          var $orig = _vm.__get_orig(item)

          var f0 = _vm._f("retainDoubleDigit")(
      ...
      : null
  var l1 =
    _vm.exclusiveScene != "" && _vm.exclusiveScene.creatives.length > 0
      ? _vm.__map(_vm.exclusiveScene.creatives, function(item, __i1__) {
          var $orig = _vm.__get_orig(item)

          var f1 = _vm._f("retainDoubleDigit")(
            item.resources[0].resourceExtInfo.playCount
          )
...
/* 18 */
/*!*******************************************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__(/*! @/static/less/index.less */ 285); //
//
//
//
//
...
var uniGrid = function uniGrid() {__webpack_require__.e(/*! require.ensure | components/uni-grid/uni-grid */ "components/uni-grid/uni-grid").then((function () {return resolve(__webpack_require__(/*! @/components/uni-grid/uni-grid.vue */ 145));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var uniGridItem = function uniGridItem() {__webpack_require__.e(/*! require.ensure | components/uni-grid-item/uni-grid-item */ "components/uni-grid-item/uni-grid-item").then((function () {return resolve(__webpack_require__(/*! @/components/uni-grid-item/uni-grid-item.vue */ 152));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var uniSearchBar = function uniSearchBar() {__webpack_require__.e(/*! require.ensure | components/uni-search-bar/uni-search-bar */ "components/uni-search-bar/uni-search-bar").then((function () {return resolve(__webpack_require__(/*! @/components/uni-search-bar/uni-search-bar.vue */ 166));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var uniDrawer = function uniDrawer() {__webpack_require__.e(/*! require.ensure | components/uni-drawer/uni-drawer */ "components/uni-drawer/uni-drawer").then((function () {return resolve(__webpack_require__(/*! @/components/uni-drawer/uni-drawer.vue */ 159));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var musicPlaybar = function musicPlaybar() {__webpack_require__.e(/*! require.ensure | components/musicPlayBar/musicPlayBar */ "components/musicPlayBar/musicPlayBar").then((function () {return resolve(__webpack_require__(/*! @/components/musicPlayBar/musicPlayBar.vue */ 173));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { uniGrid: uniGrid, uniGridItem: uniGridItem, uniSearchBar: uniSearchBar, uniDrawer: uniDrawer, musicPlaybar: musicPlaybar }, data: function data() {return { day: '', //当前日期
    ...
    this.headerPadding = uni.getSystemInfoSync()['statusBarHeight'] + 'px';this.containerPaddingTop = uni.getSystemInfoSync()['statusBarHeight'] - 25 + 149 + 'rpx';}, computed: { isShow: { //播放状态
      get: function get() {return this.$store.state.isShow;}, set: function set(v) {// 使用vuex中的mutations中定义好的方法来改变
        this.$store.commit('setisShow', v);} }, isPlay: { //播放状态
      ...
      get: function get() {return this.$store.state.isDark;}, set: function set(v) {// 使用vuex中的mutations中定义好的方法来改变
        this.$store.commit('setisDark', v);} } }, methods: { gethomedata: function gethomedata() {//获取首页数据
      ...
      var that = this;uni.showLoading({ title: '加载中...', mask: true });uni.request({ url: 'https://wx.3dcw.cn/homepage/dragon/ball', method: 'GET', success: function success(res) {var a = 0;for (var i = 0; i < res.data.data.length; i++) {switch (res.data.data[i].name) {case '每日推荐':that.iconList.push(res.data.data[i]);a++;break;case '歌单':that.iconList.push(res.data.data[i]);a++;break;case '排行榜':that.iconList.push(res.data.data[i]);a++;break;default:break;}if (a >= 3) {break;}}var increased = [];increased[0] = { iconUrl: '../../static/images/wode.png', name: '我的' };increased[1] = { iconUrl: '../../static/images/shipin.png', name: '视频' };that.iconList.push(increased[0]);that.iconList.push(increased[1]);that.gethomedata();} });}, openDrawer: function openDrawer() {//打开抽屉
      this.$refs.draw.open();this.mask = true;}, changeDrawer: function changeDrawer(e) {//抽屉状态变化
      if (!e) {this.leftdrawer = false;this.mask = false;}}, playMusic: function playMusic(songinfos, songinfospicUrl) {//播放音乐
      console.log(songinfos);var songId = songinfos.id ? songinfos.id : songinfos.resourceId;songinfos['picUrl'] = songinfospicUrl;this.$store.commit('setisPlay', true);this.$store.commit('setsongInfo', songinfos);this.getplayMusic(songId, songinfos);}, playMusicAll: function playMusicAll() {//播放全部音乐
      var that = this;var songAll = [];that.personalTailor.creatives.forEach(function (item) {item.resources.forEach(function (i) {var images = i.uiElement.image.imageUrl;i.picUrl = images;i.name = i.uiElement.mainTitle.title;songAll.push(i);});});that.$store.commit('setplaylist', songAll);that.$store.commit('setserialNumber', 0);that.getplayMusic(songAll[0].resourceId, songAll[0]);}, clearStorage: function clearStorage() {//清理缓存
      uni.clearStorage();uni.navigateTo({ url: '/pages/login/login', animationType: 'pop-in', animationDuration: 200 });}, changeFlag: function changeFlag() {//选择新歌|新碟
      this.clickFlag = !this.clickFlag;}, middleMethods: function middleMethods(index) {//二级导航跳转
      ...
      uni.navigateTo({ url: '/pages/search/search', animationType: 'pop-in', animationDuration: 200 });}, openMe: function openMe() {//打开我的页面
      uni.getStorage({ key: 'profile', success: function success(res) {uni.navigateTo({ url: '/pages/me/me', animationType: 'pop-in',
...
/* 20 */
/*!****************************************************************************************************!*\
  !*** G:/vue/Applets/cloudsuppressionmusic/pages/index/index.vue?vue&type=style&index=0&lang=less& ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
